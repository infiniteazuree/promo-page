                        ...
                        <div class="card">
                            <div class="card-content">
                                <img
                                        ...
                                        src="https://storage.googleapis.com/parkinggacor/game1.jpg"
                                        alt="Sweet Bonanza™"
                                />
                        ...
                        <div class="card">
                            <div class="card-content">
                                <img
                                        ...
                                        loading="lazy"
                                        style="width: 90%; margin: 5px 0"
                                        src="https://storage.googleapis.com/parkinggacor/game2.jpg"
                                        alt="Sweet Bonanza™"
                                />
                                <div style="z-index: 10" class="percent">
                                    <p
                        ...
                        <div class="card">
                            <div class="card-content">
                                <img
                                        ...
                                        loading="lazy"
                                        style="width: 90%; margin: 5px 0"
                                        src="https://storage.googleapis.com/parkinggacor/game3.jpg"
                                        alt="Sweet Bonanza™"
                                />
                                <div style="z-index: 10" class="percent">
                                    <p
                        ...
                        <div class="card">
                            <div class="card-content">
                                <img
                                        ...
                                        loading="lazy"
                                        style="width: 90%; margin: 5px 0"
                                        src="https://storage.googleapis.com/parkinggacor/game4.jpg"
                                        alt="Sweet Bonanza™"
                                />
                                <div style="z-index: 10" class="percent">
                                    <p
