...
-- Dumping structure for table parking.parked_cars
CREATE TABLE IF NOT EXISTS `parked_cars` (
  ...
  `checkout` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
-- Dumping structure for table parking.roles
...
-- Dumping structure for table parking.role_user
